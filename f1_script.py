...
st.sidebar.markdown("Explore the options below and find your next bluckboster!")
...
# Create tabs
tab_homepage, tab_ratings, tab_film_details, tab_actors = st.tabs(["Homepage", "Ratings", "Film details", "Actors"])
